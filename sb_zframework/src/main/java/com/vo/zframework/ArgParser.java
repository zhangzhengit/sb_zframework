...
//	}
	...
	public static List<ArgR> p(String[] args) {
		if (AU.isEmpty(args)) {
			return Collections.EMPTY_LIST;
		}
		
		List<ArgR> r = new ArrayList<>();
		...
		for (String a : args) {
			...
			String key = a.substring(pI + PREFIX.length(), eI);
...
//			System.out.println("value = " + value);
	 ...
	 * @return
	 */
	private static boolean keyContainsSpace(String key) {
